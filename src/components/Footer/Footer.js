...
function Footer() {
	return (
		...
		<Section padding="4rem 0 2rem 0">
			<FooterWrapper>
				<FooterGrid justify="space-between">
					<FooterColumn id="footerLogo">
						...
						<FooterAddress>
						6 Ballycasey Business Park, Shannon, Co. Clare V14X622
							<br></br>
							<FooterPhoneIcon>
							<Callto phone="+353830900675">Call Now! +353830900675<AiOutlinePhone/></Callto>
							</FooterPhoneIcon>
						</FooterAddress>
			...
			<Footerclaim>Heal Podiatry services can be claimed back on your health insurance plan. Check your plan today for Podiatry & Reflexology approved in your daily expenses</Footerclaim>
			<FooterRights>Heal Podiatry © 2023</FooterRights>
		</Section>
	);
}
